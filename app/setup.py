...
# Package meta-data.
NAME = "covid-local-api"
MAIN_PACKAGE = "covid_local_api"  # Change if main package != NAME
DESCRIPTION = "API to get local help information about COVID-19 (hotlines, websites, testing sites, ...)"
URL = "https://github.com/cotect/covid-local-api"
...
if sys.version_info[:1] == 3 and sys.version_info[:2] < (
    ...
    raise Exception("This package needs Python 3.7 or later.")  # 2.7,
